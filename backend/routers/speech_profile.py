...
def has_speech_profile(check_freshness: bool = True, uid: str = Depends(auth.get_current_user_uid)):
    max_age_days = 90 if check_freshness else None
    return {'has_profile': get_user_has_speech_profile(uid, max_age_days=max_age_days)}
