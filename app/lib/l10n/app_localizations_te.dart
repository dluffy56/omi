...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get get9PmReminderToReflect =>
      'మీ రోజుపై ఆలోచించడానికి సాయంత్రం 9 గంటలకు రిమైండర్ పొందండి';
  ...
  String get configurePersonaDescription =>
      'మీ AI వ్యక్తిత్వాన్ని కాన్ఫిగర్ చేయండి';
  ...
  String get getOmiDeviceDescription =>
      'మీ వ్యక్తిగత సంభాషణలతో మరింత ఖచ్చితమైన క్లోన్ సృష్టించండి';
  ...
  String get personaTwitterHandleSuspended =>
      'Twitter హ్యాండిల్ సస్పెండ్ చేయబడింది';

  @override
  String get personaFailedToVerifyTwitter =>
      'Twitter హ్యాండిల్‌ను ధృవీకరించడానికి విఫలమైంది';
  ...
  String get personaConnectKnowledgeSource =>
      'దయచేసి కనీసం ఒక జ్ఞానం డేటా మూలం (Omi లేదా Twitter) సংయోగం చేయండి';
  ...
  String get personaFailedToCreateTryLater =>
      'మీ పర్సోనాను సృష్టించడానికి విఫలమైంది. దయచేసి తరువాత ప్రయత్నించండి.';
  ...
  String get xHandlePleaseEnterValid =>
      'దయచేసి చెల్లుబాటు అయిన X హ్యాండిల్‌ను నమోదు చేయండి';
