...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get alreadySharedWithUser =>
      'आप पहले ही इस उपयोगकर्ता के साथ अपनी स्पीच प्रोफ़ाइल साझा कर चुके हैं';

  @override
  String get cannotShareWithSelf =>
      'आप अपनी स्पीच प्रोफ़ाइल स्वयं के साथ साझा नहीं कर सकते';

  @override
  String get enterUserIdToShare =>
      'जिस उपयोगकर्ता के साथ अपनी स्पीच प्रोफ़ाइल साझा करनी है उसका यूज़र आईडी दर्ज करें';

  @override
  String get noProfilesSharedWithYou =>
      'अभी तक किसी ने अपनी स्पीच प्रोफ़ाइल आपके साथ साझा नहीं की है';

  @override
  String get noSharedProfiles =>
      'आपने अभी तक अपनी स्पीच प्रोफ़ाइल किसी के साथ साझा नहीं की है';

  @override
  String get noSpeechProfileRecorded =>
      'साझा करने से पहले आपको अपनी स्पीच प्रोफ़ाइल रिकॉर्ड करनी होगी';
  ...
  String get removeSharedProfileConfirmation =>
      'क्या इस साझा स्पीच प्रोफ़ाइल का उपयोग बंद करें?';

  @override
  String get revokeShareConfirmation =>
      'क्या इस उपयोगकर्ता के साथ अपनी स्पीच प्रोफ़ाइल साझा करना बंद करें?';
