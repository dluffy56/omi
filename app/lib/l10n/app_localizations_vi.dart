...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String get alreadySharedWithUser =>
      'Bạn đã chia sẻ hồ sơ giọng nói với người dùng này rồi';

  @override
  String get cannotShareWithSelf =>
      'Bạn không thể chia sẻ hồ sơ giọng nói với chính mình';

  @override
  String get enterUserIdToShare =>
      'Nhập ID người dùng để chia sẻ hồ sơ giọng nói của bạn';

  @override
  String get noProfilesSharedWithYou =>
      'Chưa có ai chia sẻ hồ sơ giọng nói của họ với bạn';

  @override
  String get noSharedProfiles =>
      'Bạn chưa chia sẻ hồ sơ giọng nói của mình với ai';

  @override
  String get noSpeechProfileRecorded =>
      'Bạn cần ghi hồ sơ giọng nói trước khi chia sẻ';
  ...
  String get removeSharedProfileConfirmation =>
      'Dừng sử dụng hồ sơ giọng nói được chia sẻ này?';

  @override
  String get revokeShareConfirmation =>
      'Dừng chia sẻ hồ sơ giọng nói với người dùng này?';
