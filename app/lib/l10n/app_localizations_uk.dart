...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get alreadySharedWithUser =>
      'Ви вже поділилися мовним профілем із цим користувачем';

  @override
  String get cannotShareWithSelf =>
      'Ви не можете поділитися мовним профілем із собою';

  @override
  String get enterUserIdToShare =>
      'Введіть ID користувача, з яким хочете поділитися своїм мовним профілем';

  @override
  String get noProfilesSharedWithYou =>
      'Ще ніхто не поділився з вами своїм мовним профілем';

  @override
  String get noSharedProfiles =>
      'Ви ще ні з ким не поділилися своїм мовним профілем';

  @override
  String get noSpeechProfileRecorded =>
      'Перед поширенням потрібно записати мовний профіль';
  ...
  String get removeSharedProfileConfirmation =>
      'Припинити використовувати цей спільний мовний профіль?';

  @override
  String get revokeShareConfirmation =>
      'Припинити ділитися мовним профілем із цим користувачем?';
