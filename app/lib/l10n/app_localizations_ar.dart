...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get alreadySharedWithUser =>
      'لقد شاركت ملفك الصوتي بالفعل مع هذا المستخدم';
  ...
  String get noSpeechProfileRecorded =>
      'تحتاج إلى تسجيل ملفك الصوتي قبل المشاركة';
  ...
  String get removeSharedProfileConfirmation =>
      'إيقاف استخدام ملف التعريف الصوتي المُشارك هذا؟';

  @override
  String get revokeShareConfirmation =>
      'إيقاف مشاركة ملفك الصوتي مع هذا المستخدم؟';
