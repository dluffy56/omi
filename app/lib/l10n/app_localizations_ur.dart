...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get get9PmReminderToReflect =>
      'اپنے دن پر غور کرنے کے لیے رات 9 بجے کی یاد دہانی حاصل کریں';
  ...
  String get checkConnectionTryAgain =>
      'براہ کرم اپنی کنکشن چیک کریں اور دوبارہ کوشش کریں';
  ...
  String get getOmiDeviceDescription =>
      'اپنی ذاتی بات چیت کے ساتھ زیادہ درست کلون بنائیں';
  ...
  String get personaConnectKnowledgeSource =>
      'براہ کرم کم از کم ایک علم کے ڈیٹا کے ذریعہ سے منسلک کریں (Omi یا X)';
  ...
  String get personaFailedToCreateTryLater =>
      'آپ کا Persona بنانے میں ناکام۔ براہ کرم بعد میں دوبارہ کوشش کریں۔';
  ...
  String get xHandleDescription =>
      'ہم آپ کے اکاؤنٹ کی سرگرمی کی بنیاد پر آپ کے Omi کلون کو پہلے سے تربیت دیں گے';
