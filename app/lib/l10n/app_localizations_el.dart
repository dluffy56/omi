...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get alreadySharedWithUser =>
      'Έχετε ήδη κοινοποιήσει το προφίλ φωνής σας σε αυτόν τον χρήστη';

  @override
  String get cannotShareWithSelf =>
      'Δεν μπορείτε να κοινοποιήσετε το προφίλ φωνής σας στον εαυτό σας';
  ...
  String get noProfilesSharedWithYou =>
      'Κανείς δεν έχει κοινοποιήσει ακόμη το προφίλ φωνής του σε εσάς';

  @override
  String get noSharedProfiles =>
      'Δεν έχετε κοινοποιήσει ακόμη το προφίλ φωνής σας σε κανέναν';

  @override
  String get noSpeechProfileRecorded =>
      'Πρέπει να καταγράψετε το προφίλ φωνής σας πριν από την κοινοποίηση';
  ...
  String get profileSharedSuccess =>
      'Το προφίλ φωνής κοινοποιήθηκε με επιτυχία';
  ...
  String get removeSharedProfileConfirmation =>
      'Διακοπή χρήσης αυτού του κοινοποιημένου προφίλ φωνής;';

  @override
  String get revokeShareConfirmation =>
      'Διακοπή κοινοποίησης του προφίλ φωνής σας με αυτόν τον χρήστη;';
