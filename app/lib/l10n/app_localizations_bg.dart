...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get alreadySharedWithUser =>
      'Вече сте споделили гласовия си профил с този потребител';

  @override
  String get cannotShareWithSelf =>
      'Не можете да споделите гласовия си профил със себе си';

  @override
  String get enterUserIdToShare =>
      'Въведете потребителския ID, с който да споделите гласовия си профил';

  @override
  String get noProfilesSharedWithYou =>
      'Все още никой не е споделил гласовия си профил с вас';

  @override
  String get noSharedProfiles =>
      'Все още не сте споделили гласовия си профил с никого';

  @override
  String get noSpeechProfileRecorded =>
      'Трябва да запишете гласовия си профил преди споделяне';
  ...
  String get removeSharedProfileConfirmation =>
      'Да спрете използването на този споделен гласов профил?';

  @override
  String get revokeShareConfirmation =>
      'Да спрете споделянето на гласовия си профил с този потребител?';
