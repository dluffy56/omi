...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get get9PmReminderToReflect =>
      'Добивај потсетник во 21:00 да се размислиш за твојот ден';
  ...
  String get checkConnectionTryAgain =>
      'Проверете ја вашата врска и обидете се повторно';
  ...
  String get getOmiDeviceDescription =>
      'Создај пошточен клон со твои лични разговори';
  ...
  String get personaFailedToVerifyTwitter =>
      'Неуспешна проверка на Twitter рачката';
  ...
  String get personaConnectKnowledgeSource =>
      'Ве молиме поврзете најмалку еден извор на знаење (Omi или Twitter)';
  ...
  String get personaFailedToCreateTryLater =>
      'Неуспешно создавање на вашата persona. Ве молиме обидете се подоцна.';
