...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get alreadySharedWithUser =>
      'Вы уже поделились речевым профилем с этим пользователем';

  @override
  String get cannotShareWithSelf =>
      'Нельзя поделиться речевым профилем с самим собой';

  @override
  String get enterUserIdToShare =>
      'Введите ID пользователя, с которым хотите поделиться речевым профилем';

  @override
  String get noProfilesSharedWithYou =>
      'С вами ещё никто не поделился своим речевым профилем';

  @override
  String get noSharedProfiles =>
      'Вы ещё ни с кем не поделились своим речевым профилем';

  @override
  String get noSpeechProfileRecorded =>
      'Перед отправкой нужно записать речевой профиль';
  ...
  String get removeSharedProfileConfirmation =>
      'Прекратить использовать этот общий речевой профиль?';

  @override
  String get revokeShareConfirmation =>
      'Прекратить делиться речевым профилем с этим пользователем?';
